...
export default function LandlordHeader({ 
  ...
  const userMenuOptions = [
    ...
    { icon: BuildingIcon, label: 'Properties', action: () => router.push('/landlord/properties') },
    ...
    { icon: SettingsIcon, label: 'Settings', action: () => router.push('/landlord/settings') },
      ...
      <div className="px-4 py-3">
        ...
        >
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 bg-gray-100/80 border-0 rounded-xl focus:ring-2 focus:ring-green-500 focus:bg-white transition-all placeholder-gray-500 touch-manipulation shadow-sm"
