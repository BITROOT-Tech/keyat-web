//src\components\consumer\Header.tsx
'use client';
...
export default function ConsumerHeader({ 
  ...
  const userMenuOptions = [
    ...
    { icon: SettingsIcon, label: 'Settings', action: () => router.push('/consumer/settings') },
      ...
      <div className="px-4 py-3">
        ...
        >
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 bg-gray-100/80 border-0 rounded-xl focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all placeholder-gray-500 touch-manipulation shadow-sm"
