//src\components\service-provider\Header.tsx
'use client';
...
export default function ServiceProviderHeader({ 
  ...
  const userMenuOptions = [
    ...
    { icon: WrenchIcon, label: 'Services', action: () => router.push('/service-provider/services') },
    { icon: DollarSignIcon, label: 'Earnings', action: () => router.push('/service-provider/earnings') },
    { icon: UsersIcon, label: 'Clients', action: () => router.push('/service-provider/clients') },
    ...
    { icon: SettingsIcon, label: 'Settings', action: () => router.push('/service-provider/settings') },
      ...
      <div className="px-4 py-3">
        ...
        >
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 bg-gray-100/80 border-0 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:bg-white transition-all placeholder-gray-500 touch-manipulation shadow-sm"
            aria-label="Search service requests and clients"
          />
        </motion.div>
      </div>
    </motion.header>
